...
angular.module('verklizan.umox.common.html5.vkz-webrequests.domain.enums').constant('operatorMessageType', {
			...
			Alive : 8,
			SystemActionRequest : 9,
			SystemStatusUpdate : 10,
});
...
angular.module('verklizan.umox.common.html5.vkz-webrequests.domain.enums').constant('task', {
			...
			Company_Update : 60,
			Company_Delete : 61,
			ConferenceManager_DeviceStateChanged : 62,
			ConferenceManager_ExtendConferenceLifetime : 63,
			ConferenceManager_GetConferenceId : 64,
			ConferenceManager_GetConferencePartId : 65,
			ConferenceManager_GetConferenceParties : 66,
			ConferenceManager_GetOrCreateConference : 67,
			ConferenceManager_GetOrCreateConferenceParty : 68,
			ConferenceManager_MoveConferencePartyTo : 69,
			ConferenceManager_RemoveConference : 70,
			ConferenceManager_RemoveConferenceParty : 71,
			ConferenceManager_RequestConferencePartyState : 72,
			ConferenceManager_SetConferencePartyConnection : 73,
			ConsumerGroup_Create : 74,
			ConsumerGroup_Read : 75,
			ConsumerGroup_Update : 76,
			ConsumerGroup_Delete : 77,
			ConsumerState_Create : 78,
			ConsumerState_Read : 79,
			ConsumerState_Update : 80,
			ConsumerState_Delete : 81,
			ContactItemType_Create : 82,
			ContactItemType_Read : 83,
			ContactItemType_Update : 84,
			ContactItemType_Delete : 85,
			Contract_Create : 86,
			Contract_Read : 87,
			Contract_Update : 88,
			Contract_Delete : 89,
			ContractDocument_Create : 90,
			ContractDocument_Read : 91,
			ContractDocument_Update : 92,
			ContractDocument_Delete : 93,
			ContractHash_Create : 94,
			ContractHash_Read : 95,
			ContractHash_Update : 96,
			ContractHash_Delete : 97,
			Country_Create : 98,
			Country_Read : 99,
			Country_Update : 100,
			Country_Delete : 101,
			CurrentUser_Read : 102,
			Debtor_Create : 103,
			Debtor_Read : 104,
			Debtor_Update : 105,
			Debtor_Delete : 106,
			...
			Device_Update : 109,
			Device_Delete : 110,
			DeviceManagementSetting_Read : 111,
			DeviceManager_Create : 112,
			DeviceManager_Read : 113,
			DeviceManager_Update : 114,
			DeviceManager_Delete : 115,
			DeviceType_Create : 116,
			DeviceType_Read : 117,
			DeviceType_Update : 118,
			DeviceType_Delete : 119,
			DeviceState_Create : 120,
			DeviceState_Read : 121,
			DeviceState_Update : 122,
			DeviceState_Delete : 123,
			DebugService_ApplicationList_Read : 124,
			DebugService_CreateTraceLog : 125,
			DebugService_CreateTraceLogSL : 126,
			DebugService_ExtendSubscription : 127,
			DebugService_ReadTraceLogPage : 128,
			DebugService_ReadLoginTrailPage : 129,
			DebugService_Subscribe : 130,
			DebugService_TraceLevel_Update : 131,
			DebugService_UnSubscribe : 132,
			District_Create : 133,
			District_Read : 134,
			District_Update : 135,
			District_Delete : 136,
			DoctorReference_Create : 137,
			DoctorReference_Read : 138,
			DoctorReference_Update : 139,
			DoctorReference_Delete : 140,
			EmailService_SendMail : 141,
			EmailService_SendMailWithAttachment : 142,
			EmailService_SendMailTemplated : 143,
			Event_Create : 144,
			Event_Read : 145,
			Event_Update : 146,
			Event_Delete : 147,
			EventAspect_Create : 148,
			EventAspect_Read : 149,
			EventAspect_Update : 150,
			EventAspect_Delete : 151,
			EventAspectCategory_Create : 152,
			EventAspectCategory_Read : 153,
			EventAspectCategory_Update : 154,
			EventAspectCategory_Delete : 155,
			EventAspectValue_Create : 156,
			EventAspectValue_Read : 157,
			EventAspectValue_Update : 158,
			EventAspectValue_Delete : 159,
			EventPriority_Create : 160,
			EventPriority_Read : 161,
			EventPriority_Update : 162,
			EventPriority_Delete : 163,
			EventProcedure_Create : 164,
			EventProcedure_Read : 165,
			EventProcedure_Update : 166,
			EventProcedure_Delete : 167,
			EventType_Create : 168,
			EventType_Read : 169,
			EventType_Update : 170,
			EventType_Delete : 171,
			ExternalWebLinkType_Read : 172,
			GeneralDocument_Create : 173,
			GeneralDocument_Read : 174,
			GeneralDocument_Update : 175,
			GeneralDocument_Delete : 176,
			GeneralSetting_Read : 177,
			GeneralSetting_Update : 178,
			Incident_Create : 179,
			Incident_Read : 180,
			Incident_Update : 181,
			Incident_Delete : 182,
			IncidentKind_Create : 183,
			IncidentKind_Read : 184,
			IncidentKind_Update : 185,
			IncidentKind_Delete : 186,
			IncidentPriority_Create : 187,
			IncidentPriority_Read : 188,
			IncidentPriority_Update : 189,
			IncidentPriority_Delete : 190,
			IncidentProcessor_Subscription : 191,
			IncidentProcessor_GetEventDetails : 192,
			IncidentProcessor_GetEventsPage : 193,
			IncidentProcessor_GetIncidentDetails : 194,
			IncidentProcessor_GetIncidentsPage : 195,
			IncidentProcessor_PutNewEventId : 196,
			IncidentProcessor_PutNewOperatorRequest : 197,
			Insurer_Create : 198,
			Insurer_Read : 199,
			Insurer_Update : 200,
			Insurer_Delete : 201,
			InsuranceClass_Create : 202,
			InsuranceClass_Read : 203,
			InsuranceClass_Update : 204,
			InsuranceClass_Delete : 205,
			InvoiceMethod_Create : 206,
			InvoiceMethod_Read : 207,
			InvoiceMethod_Update : 208,
			InvoiceMethod_Delete : 209,
			KeyLocation_Create : 210,
			KeyLocation_Read : 211,
			KeyLocation_Update : 212,
			KeyLocation_Delete : 213,
			Language_Create : 214,
			Language_Read : 215,
			Language_Update : 216,
			Language_Delete : 217,
			License_Read : 218,
			Manage_WcfService : 219,
			Manage_ServiceInfo_Read : 220,
			Manage_ServiceInfo_Update : 221,
			MaritalState_Create : 222,
			MaritalState_Read : 223,
			MaritalState_Update : 224,
			MaritalState_Delete : 225,
			MedicalCondition_Create : 226,
			MedicalCondition_Read : 227,
			MedicalCondition_Update : 228,
			MedicalCondition_Delete : 229,
			MedicalConditionValue_Create : 230,
			MedicalConditionValue_Read : 231,
			MedicalConditionValue_Update : 232,
			MedicalConditionValue_Delete : 233,
			MedicalInfo_Create : 234,
			MedicalInfo_Read : 235,
			MedicalInfo_Update : 236,
			MedicalInfo_Delete : 237,
			MedicalPriority_Create : 238,
			MedicalPriority_Read : 239,
			MedicalPriority_Update : 240,
			MedicalPriority_Delete : 241,
			Medication_Create : 242,
			Medication_Read : 243,
			Medication_Update : 244,
			Medication_Delete : 245,
			Medicine_Create : 246,
			Medicine_Read : 247,
			Medicine_Update : 248,
			Medicine_Delete : 249,
			Module_Read : 250,
			NonPeriodicalCost_Create : 251,
			NonPeriodicalCost_Read : 252,
			NonPeriodicalCost_Update : 253,
			NonPeriodicalCost_Delete : 254,
			Operator_Create : 255,
			Operator_Read : 256,
			Operator_Update : 257,
			Operator_Delete : 258,
			Organization_Create : 259,
			Organization_Read : 260,
			Organization_Update : 261,
			Organization_Delete : 262,
			PaymentMethod_Create : 263,
			PaymentMethod_Read : 264,
			PaymentMethod_Update : 265,
			PaymentMethod_Delete : 266,
			PeriodicalCost_Create : 267,
			PeriodicalCost_Read : 268,
			PeriodicalCost_Update : 269,
			PeriodicalCost_Delete : 270,
			Person_Create : 271,
			Person_Read : 272,
			Person_Update : 273,
			Person_Delete : 274,
			Personalization_Create : 275,
			Personalization_Read : 276,
			Personalization_Update : 277,
			Personalization_Delete : 278,
			PointOfEntry_Create : 279,
			PointOfEntry_Read : 280,
			PointOfEntry_Update : 281,
			PointOfEntry_Delete : 282,
			ProfessionalCaregiver_Create : 283,
			ProfessionalCaregiver_Read : 284,
			ProfessionalCaregiver_Update : 285,
			ProfessionalCaregiver_Delete : 286,
			Project_Create : 287,
			Project_Read : 288,
			Project_Update : 289,
			Project_Delete : 290,
			PushNotificationSetting_Read : 291,
			ReferralStatus_Create : 292,
			ReferralStatus_Read : 293,
			ReferralStatus_Update : 294,
			ReferralStatus_Delete : 295,
			Region_Create : 296,
			Region_Read : 297,
			Region_Update : 298,
			Region_Delete : 299,
			RelationalCaregiver_Create : 300,
			RelationalCaregiver_Read : 301,
			RelationalCaregiver_Update : 302,
			RelationalCaregiver_Delete : 303,
			RelationType_Create : 304,
			RelationType_Read : 305,
			RelationType_Update : 306,
			RelationType_Delete : 307,
			Report_Create : 308,
			Report_Read : 309,
			Report_Update : 310,
			Report_Delete : 311,
			Residence_Create : 312,
			Residence_Read : 313,
			Residence_Update : 314,
			Residence_Delete : 315,
			ResidenceType_Create : 316,
			ResidenceType_Read : 317,
			ResidenceType_Update : 318,
			ResidenceType_Delete : 319,
			ResponderSetting_Read : 320,
			ResponderSetting_Update : 321,
			Role_Create : 322,
			Role_Read : 323,
			Role_Update : 324,
			Role_Delete : 325,
			Salutation_Create : 326,
			Salutation_Read : 327,
			Salutation_Update : 328,
			Salutation_Delete : 329,
			ScheduledTaskType_Create : 330,
			ScheduledTaskType_Read : 331,
			ScheduledTaskType_Update : 332,
			ScheduledTaskType_Delete : 333,
			ScheduledTask_Create : 334,
			ScheduledTask_Read : 335,
			ScheduledTask_Update : 336,
			ScheduledTask_Delete : 337,
			ScheduledTask_Execute : 338,
			Scheme_Create : 339,
			Scheme_Read : 340,
			Scheme_Update : 341,
			Scheme_Delete : 342,
			ServiceVersion_Read : 343,
			Setting_Read : 344,
			Setting_Update : 345,
			Skill_Create : 346,
			Skill_Read : 347,
			Skill_Update : 348,
			Skill_Delete : 349,
			SkillEventType_Create : 350,
			SkillEventType_Read : 351,
			SkillEventType_Update : 352,
			SkillEventType_Delete : 353,
			Subscriber_Create : 354,
			Subscriber_Read : 355,
			Subscriber_Update : 356,
			Subscriber_Delete : 357,
			SubscriberExternalWebLink_Create : 358,
			SubscriberExternalWebLink_Read : 359,
			SubscriberExternalWebLink_Update : 360,
			SubscriberExternalWebLink_Delete : 361,
			SubscriberHoliday_Create : 362,
			SubscriberHoliday_Read : 363,
			SubscriberHoliday_Update : 364,
			SubscriberHoliday_Delete : 365,
			SubscriberHistory_Read : 366,
			SubscriberState_Create : 367,
			SubscriberState_Read : 368,
			SubscriberState_Update : 369,
			SubscriberState_Delete : 370,
			SupportingDataManagementSetting_Read : 371,
			Tariff_Create : 372,
			Tariff_Read : 373,
			Tariff_Update : 374,
			Tariff_Delete : 375,
			...
			Task_Update : 378,
			Task_Delete : 379,
			TerminationReason_Create : 380,
			TerminationReason_Read : 381,
			TerminationReason_Update : 382,
			TerminationReason_Delete : 383,
			Title_Create : 384,
			Title_Read : 385,
			Title_Update : 386,
			Title_Delete : 387,
			UmoWebSetting_Read : 388,
			UmoWebSetting_Update : 389,
			User_Create : 390,
			User_Read : 391,
			User_Update : 392,
			User_Delete : 393,
			User_Reset : 394,
			VatTariff_Create : 395,
			VatTariff_Read : 396,
			VatTariff_Update : 397,
			VatTariff_Delete : 398,
			Warden_Create : 399,
			Warden_Read : 400,
			Warden_Update : 401,
			Warden_Delete : 402,
...
angular.module('verklizan.umox.common.html5.vkz-webrequests.general').provider('umoxServiceUrls',
    function () {
        ...
        this.$get = ['StandardUmoxServiceUrl', 'CustomServiceUrl', function (StandardUmoxServiceUrl, CustomServiceUrl) {
            var umoxService = {};

            for (var service in umoxServiceUrls) {
                umoxService[service] = {};
                var serviceMethods = umoxServiceUrls[service];
...
angular.module("verklizan.umox.common.html5.vkz-webrequests.proxy").config(
	["umoxServiceUrlsProvider", "urlConstants",
		function (umoxServiceUrlsProvider, urlConstants) {
